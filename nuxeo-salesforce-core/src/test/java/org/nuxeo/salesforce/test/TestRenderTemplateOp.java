...
import org.nuxeo.salesforce.RenderTemplateOp;
...
public class TestRenderTemplateOp {
    ...
    public void TestRender() throws Exception {
        ...
        OperationChain chain = new OperationChain("TestRenderTemplateOp");
        ...
        chain.add(RenderTemplateOp.ID).
                set("templateUid", template.getId()).
                set("owner", userProps).
